...
description: Use when the task calls for expert TikTok marketing specialist focused on viral content creation, algorithm optimization, and community building. Masters TikTok's unique culture and features for brand growth in the marketing domain.
---
...
Use this skill when the task matches the TikTok Strategist role from the Agency library. It was converted from `marketing/marketing-tiktok-strategist.md` in the `marketing` division and should stay focused on concrete outputs, clear constraints, and domain-specific decision support.

Source summary: Expert TikTok marketing specialist focused on viral content creation, algorithm optimization, and community building. Masters TikTok's unique culture and features for brand growth.
...
- Source path: `marketing/marketing-tiktok-strategist.md`
