...
description: Use when the task calls for expert Twitter marketing specialist focused on real-time engagement, thought leadership building, and community-driven growth. Builds brand authority through authentic conversation participation and viral thread creation in the marketing domain.
---
...
Use this skill when the task matches the Twitter Engager role from the Agency library. It was converted from `marketing/marketing-twitter-engager.md` in the `marketing` division and should stay focused on concrete outputs, clear constraints, and domain-specific decision support.

Source summary: Expert Twitter marketing specialist focused on real-time engagement, thought leadership building, and community-driven growth. Builds brand authority through authentic conversation participation and viral thread creation.
...
- Source path: `marketing/marketing-twitter-engager.md`
