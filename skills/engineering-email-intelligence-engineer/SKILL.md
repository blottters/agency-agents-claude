...
description: Use when the task calls for expert in extracting structured, reasoning-ready data from raw email threads for AI agents and automation systems in the engineering domain.
---
...
- Source path: `engineering/engineering-email-intelligence-engineer.md`
